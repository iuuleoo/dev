    ...
    <section className="bg-[#FFD339] py-16 ">
      <div className="container mx-auto px-4">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <button
            className=" bg-white items-center justify-center rounded-full shadow-lg w-10 h-10 absolute left-3 -translate-y-1/2 -translate-x-1/2 top-1/2 z-10"
            onClick={scrollPrev}
          >
          ...
          <button
            className=" bg-white items-center justify-center rounded-full shadow-lg w-10 h-10 absolute -right-6 -translate-y-1/2 -translate-x-1/2 top-1/2 z-10"
            onClick={scrollNext}
          >
